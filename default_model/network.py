...
from dataset import multi_classification
...
def network(model, epochs = 100, batch_size = 32, lr = 0.0001):
    ...
    trainset = multi_classification(root = '/home/junkyu/project/tumor_detection/default_model/data/',
    ...
    testset = multi_classification(root = '/home/junkyu/project/tumor_detection/default_model/data/',
                                transform = T.Compose([T.RandomRotation(5),
                                                        T.RandomVerticalFlip(),
                                                        T.RandomHorizontalFlip(),
                                                        T.ColorJitter(brightness=random.random(),
