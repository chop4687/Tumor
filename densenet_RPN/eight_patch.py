...
from utils.dataset import eight_patch
...
if __name__ == '__main__':
    ...
    train_data = eight_patch(root = '/home/junkyu/project/tumor_detection/densenet_RPN/data/',transform = T.Compose([
                                # T.RandomRotation(5),
    ...
    for i,(input, bbox_label, mask) in enumerate(train_loader):
        ...
        if arg_cls[0,idx[0,0],1] < 0.5:
            x_min, y_min, w, h = pred[0,:].int()
            black[x_min:(x_min + w),y_min:(y_min+h)] += 1
